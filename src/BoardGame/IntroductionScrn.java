...
public IntroductionScrn() {
        initComponents();
        scaleBackgroundImage(); // Renombrado para mayor claridad
        scaleLogoImage();       // Nuevo método para escalar el logo
    }
    ...
    private void scaleLogoImage() {
        // Carga el logo, que ahora esperamos que sea transparente
